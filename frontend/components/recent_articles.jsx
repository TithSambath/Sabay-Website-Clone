          ...
          return (
            <Link href="/article/we-love-pizza">
              ...
              >
                <div
                  className={classNames(
                    "bg-cover bg-center h-64 object-center bg-preview-image",
                    width
                  )}
                >
                  <div
                    className={classNames(
                      "group layer-overlay w-full h-full flex bg-black-opt-50 cursor-pointer relative max-h-64",
                      width
                    )}
                  >
                    <div className="article-info w-full absolute bottom-0 p-5">
                      <h3
                        className="title text-2xl transition duration-500 ease-in-out 
                      ...
                      <h6
                        className="group-hover:block transition-all duration-500 ease-in-out 
                                                             text-white text-base font-hanuman translate-y-16 opacity-0 
                                                               group-hover:translate-y-0 group-hover:opacity-100"
                      >
                        មកលើកនេះទ្រង់ទ្រាយយក្សហ្មង! មិនត្រឹម​តែ Comeback ទេ មាន
                        World Tour ទៀត
                      </h6>
                    </div>
                  </div>
