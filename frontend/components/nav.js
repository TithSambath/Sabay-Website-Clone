...
const Nav = ({ categories }) => {
  ...
  const isActive = (pathname) => {
    ...
    if (pathname == "/")
      return "bg-secon-custom-red text-white font-bold";
        ...
        <div className="container md:w-750px lg:w-970px xl:w-1170px m-auto">
          <div className="nav-head flex">
            <div className="uk-navbar-left pl-5 pr-5">
              <Link href={'/'}>
                <img width={80} className="cursor-pointer" src="https://news.sabay.com.kh/img/logo.png" />
              </Link>
            </div>
          </div>
        </div>
          ...
          <ul className="pl-5 pr-5 flex justify-between h-full z-50 md:w-750px lg:w-970px xl:w-1170px m-auto font-bold text-gray-300">
            <Link href='/'>
              <li
                ...
                <a className="uk-link-reset uppercase">Home</a>
              </li>
            </Link>
            {
                ...
                return (
                  <Link href={`/category/${category.attributes.slug}`}>
                    <li
                      ...
                      <a className="uk-link-reset uppercase">{category.attributes.name}</a>
                    </li>
                  </Link>
                )
              })
      ...
      <nav className="sm-nav bg-black pt-4 pb-4 font-bayon text-lg block w-full md:hidden">
        <div className="container w-full m-auto">
          <div className="nav-head w-full flex justify-between">
            ...
            <Link href={'/'}>
              <img width={40} className="cursor-pointer" src="https://news.sabay.com.kh/img/logo.png" />
            </Link>
            <img width={40} className="cursor-pointer" src="https://media.sabay.com/media/Testing(1)/gif/611c767eaf4c2_1629255240.gif" />
          </div>
          <ul id="sm-nav" className="hidden w-full mt-5">
            <Link href='/'>
              <li
                ...
                <a className="uk-link-reset uppercase">
